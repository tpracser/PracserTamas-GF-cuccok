...
def words(sentence):
    # result = sentence[0:-1]
    # result = result.split()
    result = sentence[0:-1].split()
    return result

print(words("Create a method that gets a long sentence as param."))
...
print(sentence(['Create', 'a', 'method', 'that', 'gets', 'a', 'long', 'sentence', 'as', 'param']))
